...
def login():
    ...
    try:
        ...
        # ==========================================
        # ИЩЕМ WOOCOMMERCE LOGIN
        # ==========================================

        form = soup.find(
            "form",
            class_=lambda x: x and "woocommerce-form-login" in x
        )
        ...
        if not form:
            ...
            print("❌ LOGIN FORM STILL NOT FOUND")
        ...
        print(
            f"🔎 LOGIN CHECK: {check.status_code}"
        )
